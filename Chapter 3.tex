...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Figures/NCCL.PNG}
        \caption{Giao tiếp tập thể sử dụng thư viện NCCL trên nhiều GPU}
        \label{fig:nccl_comm}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Figures/NVSHMEM.png}
        \caption{Mô hình bộ nhớ chia sẻ toàn cục phân vùng PGAS của NVSHMEM}
        \label{fig:nvshmem_comm}
    \end{figure}
\end{itemize}